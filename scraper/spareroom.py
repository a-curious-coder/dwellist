import datetime
from scraper.utilities import DwellistLogger
import traceback
...
from scraper.searchconstructor import SearchConstructor
...
class Room:
    ...
    def __init__(self, room_soup, domain):
        ...
        self.latitude = self.location_coords[0]
        self.longitude = self.location_coords[1]
